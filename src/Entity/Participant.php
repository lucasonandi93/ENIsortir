...
class Participant
{
    ...
    private Collection $sortir;

    public function __construct()
    {
        $this->organisateur = new ArrayCollection();
        $this->sortir = new ArrayCollection();
    }
     ...
     * @return Collection<int, Sortie>
     */
    public function getSortir(): Collection
    {
        return $this->sortir;
    }

    public function addSortir(Sortie $sortir): self
    {
        if (!$this->sortir->contains($sortir)) {
            $this->sortir->add($sortir);
        }

        return $this;
    }

    public function removeSortir(Sortie $sortir): self
    {
        $this->sortir->removeElement($sortir);
